...
echo Delete previously generated cs code files 
 ...
 DEL /F "..\ProCsGo.Domain\Domain\2_t4DomainViewModelsGenerate.cs"	
 ::DEL /F "..\ProCsGo.Domain\Mapping\3_t4DomainMappingProfileGenerate.cs"	
 DEL /F "..\ProCsGo.Domain\Service\4_t4DomainServicesGenerate.cs"	
 ::DEL /F "..\ProCsGo.Api\Controllers\5_t4ApiControllerGenerate.cs"	
 ::DEL /F "..\ProCsGo.Test\6_t4IntegrationTestGenerate.cs"
echo .
echo Run all T4s...
echo -generate entity helpers
%tt% "1_t4EntityHelpersGenerate.tt" -out "1_t4EntityHelpersGenerate.cs"
echo -generate domain classes
%tt% "..\ProCsGo.Domain\Domain\2_t4DomainViewModelsGenerate.tt" -out "..\ProCsGo.Domain\Domain\2_t4DomainViewModelsGenerate.cs"
echo -generate mapper classes
::%tt% "..\ProCsGo.Domain\Mapping\3_t4DomainMappingProfileGenerate.tt" -out "..\ProCsGo.Domain\Mapping\3_t4DomainMappingProfileGenerate.cs"	
echo -generate services classes
%tt% "..\ProCsGo.Domain\Service\4_t4DomainServicesGenerate.tt" -out "..\ProCsGo.Domain\Service\4_t4DomainServicesGenerate.cs"	
echo -generate controller classes
::%tt% "..\ProCsGo.Api\Controllers\5_t4ApiControllerGenerate.tt" -out "..\ProCsGo.Api\Controllers\5_t4ApiControllerGenerate.cs"	
echo -generate test classes
::%tt% "..\ProCsGo.Test\6_t4IntegrationTestGenerate.tt" -out "..\ProCsGo.Test\6_t4IntegrationTestGenerate.cs"	
echo T4s completed.
pause
:END